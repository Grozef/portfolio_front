...
// Computed pour afficher le temps restant formate
...
/**
 * Demarre le compte a rebours de blocage.
...
const handleSubmit = async () => {
  ...
  if (success) {
    ...
    // Compte bloque - demarrer le compte a rebours
  ...
  <div class="login-page">
    ...
    <main class="login-main">
      <div class="login-card">
        ...
        <form @submit.prevent="handleSubmit" class="login-form">
          ...
          <!-- Message d'erreur ou compte a rebours -->
    ...
    <footer class="page-footer">
      <div class="footer-nav">
        ...
        <router-link to="/books" data-cursor-hover>Books</router-link>
      </div>
    </footer>
  </div>
</template>
...
.password-input {
  ...
  .toggle-password {
    ...
    &:hover { color: var(--terminal-accent); }
  }
}
